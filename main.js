...
function init() {
  ...
  audioLoader.load('audio1.mp3', (buffer) => {
    ...
    sound.setLoop(true); // Set to loop the music playback
    sound.setVolume(0.05); // Set the volume between 0 (silent) and 1 (full volume)
...
function generateBox(x, y, z, width, depth, falls) {
  ...
  const color = new THREE.Color(`hsl(${120 -( stack.length * 5)}, 100%, 50%)`);
